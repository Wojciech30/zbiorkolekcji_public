<!--
  @view LoginView
  @description Formularz logowania użytkownika.
  Obsługuje: logowanie, błędy weryfikacji, ponowne wysłanie linku weryfikacyjnego.
-->
<template>
  <div>
...
export default {
  ...
  setup() {
    ...
    // Stan ponownej weryfikacji email
    ...
    // Obsługa ponownego wysyłania linku aktywacyjnego
